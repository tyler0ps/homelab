locals {
  talos_nodes = {
    "controlplane-01" = { target_node = "node01", role = "controlplane", disk_size = "20G", disk_storage = "local" }
    "controlplane-02" = { target_node = "tylerops", role = "controlplane", disk_size = "30G", disk_storage = "local" }
    "controlplane-03" = { target_node = "node01", role = "controlplane", disk_size = "20G", disk_storage = "local" }
